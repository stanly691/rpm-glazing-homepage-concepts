...
$hero_video = $img_url( clarity_home( 'hero_video', '' ) );
...
<section class="hero" style="background-image:url('<?php echo esc_url( $poster ); ?>')">
	...
	<div class="hero-inner wrap">
		<span class="pill"><img src="<?php echo esc_url( $mk . 'icon-customer-care.webp' ); ?>" alt=""><?php echo esc_html( clarity_home( 'hero_pill', '24/7 Remote Support Available' ) ); ?></span>
		<h1><?php echo nl2br( esc_html( clarity_home( 'hero_heading', "Empowering Productivity Through\nSharp Technology" ) ) ); ?></h1>
		<p><?php echo esc_html( clarity_home( 'hero_text', 'Managed print and document solutions that save time, reduce waste and keep your business moving. Trusted by businesses across the UK for 30 years.' ) ); ?></p>
		<div class="hero-actions">
			<a class="btn btn-red" href="<?php echo esc_url( clarity_home( 'hero_btn1_url', '/contact/' ) ); ?>"><?php echo esc_html( clarity_home( 'hero_btn1_label', 'Get a Quote' ) ); ?></a>
			<a class="btn btn-ghost" href="<?php echo esc_url( clarity_home( 'hero_btn2_url', '/support/' ) ); ?>"><?php echo esc_html( clarity_home( 'hero_btn2_label', 'Get Remote Support' ) ); ?></a>
		</div>
	</div>
</section>
...
<section class="sectors center">
	<div class="wrap">
		<h2 class="h2"><?php echo esc_html( clarity_home( 'sectors_heading', 'Expertise Across Sectors' ) ); ?></h2>
		<p class="intro"><?php echo esc_html( clarity_home( 'sectors_intro', 'We understand that every industry has unique challenges. Our tailored managed print solutions address sector-specific needs with precision and expertise.' ) ); ?></p>
		<div class="grid4">
			<?php foreach ( clarity_home_rows( 'sectors', $def_sectors ) as $s ) : ?>
			<div class="icard">
...
<section class="why center">
	<div class="wrap">
		<h2 class="h2"><?php echo esc_html( clarity_home( 'why_heading', 'Why Choose Clarity?' ) ); ?></h2>
		<p class="intro"><?php echo esc_html( clarity_home( 'why_intro', 'Local engineers, genuine Sharp equipment and three decades of experience. Here is why businesses across South Wales choose Clarity Copiers Glamorgan.' ) ); ?></p>
		<div class="grid4">
			<?php foreach ( clarity_home_rows( 'why_items', $def_why ) as $w ) : ?>
			<div class="icard">
...
<section class="team">
	<div class="wrap">
		<?php $team_raw = clarity_home( 'team_image', $mk . 'team.webp' ); echo clarity_img( $team_raw, 'large', array( 'class' => 'team-img', 'alt' => 'The Clarity Copiers team', 'sizes' => '(max-width:1023px) 100vw, 44vw' ) ); ?>
		<div class="team-txt">
			<h2><?php echo esc_html( clarity_home( 'team_heading', 'Meet Our Team' ) ); ?></h2>
			<p><?php echo esc_html( clarity_home( 'team_text', "Led by Warren Dryden, our dedicated team combines decades of experience with a passion for exceptional customer service. We're not just your supplier – we're your technology partner." ) ); ?></p>
			<a class="btn btn-outline" href="<?php echo esc_url( clarity_home( 'team_btn_url', '/our-team/' ) ); ?>"><?php echo esc_html( clarity_home( 'team_btn_label', 'Learn More' ) ); ?></a>
		</div>
	</div>
</section>
...
<section class="products">
	<div class="wrap">
		<div class="head-row">
			<div>
				<h2 class="h2"><?php echo esc_html( clarity_home( 'products_heading', 'Products & Services' ) ); ?></h2>
				<p class="intro"><?php echo esc_html( clarity_home( 'products_intro', 'Comprehensive Sharp technology solutions designed to meet every business need. From multifunction printers to interactive displays and cloud services.' ) ); ?></p>
			</div>
			<a class="btn btn-outline tall" href="<?php echo esc_url( home_url( '/products/' ) ); ?>">View All</a>
		</div>
		<div class="grid3">
			<?php foreach ( clarity_home_rows( 'products', $def_products ) as $p ) : ?>
...
<section class="testimonials center">
	<div class="wrap">
		<h2 class="h2"><?php echo esc_html( clarity_home( 'testimonials_heading', 'What Our Clients Say' ) ); ?></h2>
		<p class="intro"><?php echo esc_html( clarity_home( 'testimonials_intro', "Don't just take our word for it. Here's what our satisfied clients have to say about our service." ) ); ?></p>
		<div class="grid3">
			<?php foreach ( clarity_home_rows( 'testimonials', $def_tests ) as $t ) : ?>
			<div class="tcard">
...
<section class="news">
	<div class="wrap">
		<div class="head-row">
			<div>
				<h2 class="h2"><?php echo esc_html( clarity_home( 'news_heading', 'Latest News & Insights' ) ); ?></h2>
				<p class="intro"><?php echo esc_html( clarity_home( 'news_intro', 'Stay updated with the latest product releases, industry insights, and company news.' ) ); ?></p>
			</div>
			<a class="btn btn-outline tall" href="<?php echo esc_url( get_permalink( get_option( 'page_for_posts' ) ) ?: home_url( '/news/' ) ); ?>">View All News</a>
		</div>
		<?php $news = get_posts( array( 'numberposts' => 3 ) ); ?>
		<div class="grid3<?php echo count( $news ) < 3 ? ' is-short' : ''; ?>">
			<?php
			if ( $news ) :
